...
<div style="margin-top:60px">
    <div style="padding: 20px 20px 40px;background: #f3f3f4; ">
        <div style="background:#fff;padding: 15px 20px 15px 15px;    border-top: 2px solid #e6e6e6;border-bottom: 1px solid #e6e6e6;">
            <span style="font-size: 14px;font-weight:600;color:#676a6c">已入驻小区</span>
            <el-button style="float:right" type="success" icon="el-icon-plus" @click="dialogVisible = true">入驻小区</el-button>
        </div>
        <el-table
      :data="tableData"
