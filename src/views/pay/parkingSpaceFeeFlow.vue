...
<div style="margin-top:60px">
    <div style="padding: 20px 20px 40px;background: #f3f3f4; ">
        <div style="background:#fff;padding: 15px 20px 15px 15px;    border-top: 2px solid #e6e6e6;border-bottom: 1px solid #e6e6e6;">
            <span style="font-size: 14px;font-weight:600;color:#676a6c">停车费信息</span>
            <el-button style="float:right" type="success" icon="el-icon-search" @click="dialogVis = true">选择停车位</el-button>
        </div>
        <div style="background:#fff;     flex-wrap: wrap;   padding: 20px 20px 50px 20px;    display: flex;">
            ...
            <div style="width:30%">
                <p style="color:#676a6c;font-size: 13px;">停车位编号：<span></span></p>
            </div>
            <div style="width:30%">
                <p style="color:#676a6c;font-size: 13px;">车位类型：<span></span></p>
            </div>
            <div style="width:30%;margin-top:30px">
                <p style="color:#676a6c;font-size: 13px;">车牌号：<span></span></p>
            </div>
            <div style="width:30%;margin-top:30px">
                <p style="color:#676a6c;font-size: 13px;">车品牌：<span></span></p>
            </div>
            <div style="width:30%;margin-top:30px">
                <p style="color:#676a6c;font-size: 13px;">车类型：<span></span></p>
            </div>
            <div style="width:30%;margin-top:30px">
        ...
        width="60%">
          ...
          <el-form ref="form" style="display: flex;margin-top: 0px;" :model="params" label-width="80px">
            <el-form-item style="    margin-top: -6px;">
                <el-input v-model="params.name" placeholder="输入车牌号"></el-input>
            </el-form-item>
            <el-form-item style="    margin-top: -6px;">
